 ...
 * 1. removing `using namespace std` and making the subsequent required modifications (May 2024)
 * 2. putting the code under the xoos::stats namespace (March 2026)
 * 3. removing the ifault pointer argument, replacing ifault with runtime errors (May 2024)
 * 4. various changes to support our linters (May 2024)
 * 5. removed unnecessary include statements (March 2026)
 */
#include "asa243.hpp"
...
//    beta function.
//
//    Output, int *IFAULT, error flag. NOTE: removed
//    0, no error.
...
//
{
  ...
  //
  if (p <= 0.0 || q <= 0.0) {
    throw std::runtime_error("betain p and q must be positive non-0");
  }

  if (x < 0.0 || 1.0 < x) {
    throw std::runtime_error("betain x must be stictly between 0 and 1");
  }
  //
  //  Special cases.
  //
  if (x == 0.0 || x == 1.0) {
    throw std::runtime_error("betain x not equal either 0 or 1");
  }
  //
...
void student_noncentral_cdf_values(int* n_data, int* df, double* lambda, double* x, double* fx)
...
#define N_MAX 30
  ...
  int df_vec[N_MAX] = {1,  2,  3,  1, 2, 3, 1,  2,  3,  1,  2,  3,  1,  2,  3,
                       15, 20, 25, 1, 2, 3, 10, 10, 10, 10, 10, 10, 10, 10, 10};

  double fx_vec[N_MAX] = {
      0.8975836176504333E+00, 0.9522670169E+00, 0.9711655571887813E+00, 0.8231218864E+00,   0.9049021510E+00,
      0.9363471834E+00,       0.7301025986E+00, 0.8335594263E+00,       0.8774010255E+00,   0.5248571617E+00,
      0.6293856597E+00,       0.6800271741E+00, 0.20590131975E+00,      0.2112148916E+00,   0.2074730718E+00,
      0.9981130072E+00,       0.9994873850E+00, 0.9998391562E+00,       0.168610566972E+00, 0.16967950985E+00,
      0.1701041003E+00,       0.9247683363E+00, 0.7483139269E+00,       0.4659802096E+00,   0.9761872541E+00,
      0.8979689357E+00,       0.7181904627E+00, 0.9923658945E+00,       0.9610341649E+00,   0.8688007350E+00};

  double lambda_vec[N_MAX] = {0.0E+00, 0.0E+00, 0.0E+00, 0.5E+00, 0.5E+00, 0.5E+00, 1.0E+00, 1.0E+00, 1.0E+00, 2.0E+00,
                              2.0E+00, 2.0E+00, 4.0E+00, 4.0E+00, 4.0E+00, 7.0E+00, 7.0E+00, 7.0E+00, 1.0E+00, 1.0E+00,
                              1.0E+00, 2.0E+00, 3.0E+00, 4.0E+00, 2.0E+00, 3.0E+00, 4.0E+00, 2.0E+00, 3.0E+00, 4.0E+00};

  double x_vec[N_MAX] = {3.00E+00,  3.00E+00,  3.00E+00, 3.00E+00, 3.00E+00, 3.00E+00, 3.00E+00, 3.00E+00,
                         3.00E+00,  3.00E+00,  3.00E+00, 3.00E+00, 3.00E+00, 3.00E+00, 3.00E+00, 15.00E+00,
                         15.00E+00, 15.00E+00, 0.05E+00, 0.05E+00, 0.05E+00, 4.00E+00, 4.00E+00, 4.00E+00,
                         5.00E+00,  5.00E+00,  5.00E+00, 6.00E+00, 6.00E+00, 6.00E+00};
...
//
{
  ...
  if (df <= 0.0) {
    throw std::runtime_error("tnc df must be positive");
  }
